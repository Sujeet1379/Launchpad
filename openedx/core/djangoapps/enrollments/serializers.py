...
from openedx.core.djangoapps.content.course_overviews.models import CourseLiveClasses, CourseOverview
...
class CourseLiveClassesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'start_time' ,'end_time' , 'date' , 'course_id')

    # def get_start_time(self, obj):
    #     log.info('inside course serializer', isinstance(obj, bool))
    #     return 1
...
class CourseEnrollmentSerializer(serializers.ModelSerializer):
    ...
    course_live_class= CourseLiveClassesSerializer()
    ...
    class Meta:
        ...
        fields = ('created', 'mode', 'is_active', 'course_details', 'user' , 'course_price' , 'course_live_class' ) # , 'price')
